...
header:
  teaser: "publications/00_DMDR.png"   # small thumbnail shown on the /publications/ list
  image:  "publications/00_DMDR.png"   # (optional) banner shown at the top of this paper's own page
---
