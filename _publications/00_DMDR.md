...
header:
  teaser: "publications/DMDR.png"   # small thumbnail shown on the /publications/ list
  image:  "publications/DMDR.png"   # (optional) banner shown at the top of this paper's own page
---
